...
BLOG_AUTHOR = "Craig Allen"  # (translatable)
BLOG_TITLE = "Successive Approximation"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://knodalyte.github.io/SuccessiveApproximation/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://knodalyte.github.io/SuccessiveApproximation/"
BLOG_EMAIL = "cba@knodal.com"
BLOG_DESCRIPTION = "Asking the right questions for a long time now"  # (translatable)
